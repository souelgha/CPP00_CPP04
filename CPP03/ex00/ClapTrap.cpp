...
{
	std::cout <<"constructeur par defaut de " << this->_Name << std::endl;
}
ClapTrap::ClapTrap(std::string nom):_Name(nom),Hit_points(10), Energy_points(10), Attack_damage(0)
{
	std::cout <<"constructeur avec parametres de "<< this->_Name  << std::endl;
}
ClapTrap::ClapTrap(const ClapTrap& other)
{
	...
	std::cout <<"constructeur de copie de "<< this->_Name  << std::endl;
}
...
ClapTrap::~ClapTrap()
{
	std::cout <<"destructeur par defaut de "<< this->_Name  << std::endl;
}
